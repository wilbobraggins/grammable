...
RSpec.describe GramsController, type: :controller do
  describe "grams#destroy action" do
    ...
    it "should retrun a 404 message if we cannot find a gram with the id that is specified" do
      user = FactoryBot.create(:user)
      sign_in user
  ...
  describe "grams#edit action" do
    ...
    it "should retrun a 404 error message if the gram is not found" do
      user = FactoryBot.create(:user)
      sign_in user
